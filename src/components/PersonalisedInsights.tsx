...
COMMUNICATION STYLE: ${report.insights.communicationStyle || 'Not analyzed'}
...
MOOD TRENDS:
Pattern: ${report.insights.moodTrends?.pattern || 'Not analyzed'}
                  ...
                  <Card className="lg:col-span-2">
                    ...
                    <CardContent className="p-4 sm:p-6 pt-0">
                      <div className="space-y-3 sm:space-y-4">
                        {(currentReport.insights.personalisedRecommendations || []).map((rec, index) => (
                    ...
                    <CardContent className="p-4 sm:p-6 pt-0">
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm sm:text-base">
                        <div className="p-3 rounded-lg bg-muted/30 text-center sm:text-left">
                          <p className="text-muted-foreground text-xs sm:text-sm">Conversations Analyzed</p>
                        ...
                        <div className="p-3 rounded-lg bg-muted/30 text-center sm:text-left">
                          ...
                          <p className="font-medium text-lg sm:text-xl">{currentReport.mood_entries_analyzed}</p>
                        </div>
                        <div className="p-3 rounded-lg bg-muted/30 text-center sm:text-left">
