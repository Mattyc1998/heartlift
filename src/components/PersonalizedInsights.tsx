...
This report was generated by AI analysis of your conversations with HeartWise coaches and mood tracking data.
    `;
    ...
    a.href = url;
    a.download = `heartwise-insights-${new Date(report.created_at).toISOString().split('T')[0]}.txt`;
