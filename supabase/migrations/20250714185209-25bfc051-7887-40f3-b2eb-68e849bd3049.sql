-- Update subscribers table to include premium plan details
ALTER TABLE public.subscribers ADD COLUMN IF NOT EXISTS plan_type TEXT DEFAULT 'free';
ALTER TABLE public.subscribers ADD COLUMN IF NOT EXISTS premium_start_date TIMESTAMP WITH TIME ZONE;
ALTER TABLE public.subscribers ADD COLUMN IF NOT EXISTS payment_status TEXT DEFAULT 'inactive';
ALTER TABLE public.subscribers ADD COLUMN IF NOT EXISTS last_used_premium_feature TIMESTAMP WITH TIME ZONE;
