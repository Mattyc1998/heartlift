      ...
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-8" style={{ paddingTop: 'calc(env(safe-area-inset-top, 20px) + 2rem)' }}>
        ...
        {(isPremium || hasHealingKit) && (
          <div className="flex justify-center gap-2 mb-6">
            ...
            {hasHealingKit && (
              <Link to="/healing-kit">
                <Button variant="outline" className="flex items-center gap-2 hover:shadow-md transition-all">
        ...
        <div className="flex items-center justify-between mb-4 sm:mb-8">
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <h1 className="text-xl sm:text-2xl font-bold">
              Heart
              <span className="bg-gradient-to-r from-primary via-primary to-primary bg-clip-text text-transparent font-black">
                Lift
              </span>
            </h1>
          </div>
