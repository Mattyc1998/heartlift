              ...
              <div className="space-y-3">
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-1 text-sm">
                    ...
                    <li><strong>Supabase (PostgreSQL):</strong> All application data including authentication, conversations, daily reflections, insights reports, usage tracking, HeartVisions gallery, and quiz results</li>
