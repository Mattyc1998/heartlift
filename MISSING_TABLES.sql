-- Create only the missing tables for Supabase migration
-- Run this in Supabase SQL Editor

-- 1. Usage Tracking Table (for coach chat analytics)
...
-- 3. Daily Usage Table (for message limits)
